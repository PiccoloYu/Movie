...
<head><title>看电影的好网站,免费电影在线观看 </title>
            ...
            <div class="stui-header_bd clearfix">
                ...
                <div class="stui-header__side">
                    <ul class="stui-header__user">
                        <li class="hidden-xs"><a href="#" id="example"><i class="icon iconfont icon-account" id="login1"></i></a></li>
                ...
                <ul class="stui-header__menu type-slide">
                    ...
                    <li><a href="/dm/index.html"> 动漫</a></li><!-- <li><a href="/news/">资讯</a></li> -->
                </ul>
            </div>
        </div>
    </div>
...
<!--登录弹窗-->
  ...
  <div class="form" id="LoginBox">  
   <a href="javascript:void(0)" title="关闭窗口" class="close_btn" id="closeBtn" style="position:absolute;right: 10px;top:10px">×</a>
      <ul class="tab-group">
      ...
      <div class="tab-content">
        <div id="signup">   
          ...
          <div class="top-row">
            ...
            <div class="field-wrap">
              <label>
               重复密码<span class="req">*</span>
              </label>
              <input type="text"required autocomplete="off" name="passWord1"/>
            </div>
          </div>

          <div class="field-wrap">
            <label>
              手机验证码<span class="req">*</span>
            </label>
          ...
          <div class="field-wrap">
            ...
            <input type="password" required autocomplete="off" name="passWord"/>
              ...
              <div class="field-wrap">
                  ...
                  <input type="text" required autocomplete="off" class="text" id="verifyCode"  name="verifyCode" tabindex="1" style="width: 300px">
                  <img src="${pageContext.request.contextPath}/getVerifyCode" width="140" height="40" id="verifyCodeImage" onclick="changeImage()"
                       title="看不清换一张" style="position:absolute;top:0px;right: 0px">
              </div>
...
<div class="container">
    <div class="row"><!-- D082 by v.shoutu.cn -->
        <div class="stui-pannel stui-pannel-bg clearfix">
            <div class="stui-pannel-box">
                <div class="stui-pannel_bd"><a class="more text-muted pull-right" href="/search.php?searchtype=5&tid=1">更多
                    ...
                    <h3 class="title"><img src="/static/icon/icon_6.png"/>热播推荐</h3>
                ...
                <div class="col-lg-wide-75 col-xs-1 padding-0">
                    <div class="stui-pannel_hd">
                        <div class="stui-pannel__head clearfix"><a class="more text-muted pull-right"
                            ...
                            <h3 class="title"><img src="/static/icon/icon_29.png"/><a href="/dy/index.html">电影</a></h3>
                ...
                <div class="col-lg-wide-25 hidden-md hidden-sm hidden-xs">
                    <div class="stui-pannel_hd">
                        <div class="stui-pannel__head clearfix"><a class="more text-muted pull-right"
                            ...
                            <i class="icon iconfont icon-more"></i></a>
                            <h3 class="title"><img src="/static/icon/icon_12.png"/>热播榜</h3></div>
                    </div>
                    ...
                    <div class="stui-pannel_hd">
                        <div class="stui-pannel__head clearfix"><a class="more text-muted pull-right"
                                ...
                                class="icon iconfont icon-more"></i></a>
                            <h3 class="title"><img src="/static/icon/icon_25.png"/>筛选</h3></div>
                    </div>
                ...
                <div class="col-lg-wide-75 col-xs-1 padding-0">
                    <div class="stui-pannel_hd">
                        <div class="stui-pannel__head clearfix"><a class="more text-muted pull-right"
                                ...
                                class="icon iconfont icon-more"></i></a>
                            <h3 class="title"><img src="/static/icon/icon_30.png"/><a href="/dsj/index.html">电视剧</a>
                            </h3>
                            <ul class="nav nav-text pull-right hidden-sm hidden-xs">
                ...
                <div class="col-lg-wide-75 col-xs-1 padding-0">
                    <div class="stui-pannel_hd">
                        <div class="stui-pannel__head clearfix"><a class="more text-muted pull-right"
                                ...
                                class="icon iconfont icon-more"></i></a>
                            <h3 class="title"><img src="/static/icon/icon_31.png"/><a href="/zy/index.html">综艺</a></h3>
                ...
                <div class="col-lg-wide-75 col-xs-1 padding-0">
                    <div class="stui-pannel_hd">
                        <div class="stui-pannel__head clearfix"><a class="more text-muted pull-right"
                                ...
                                class="icon iconfont icon-more"></i></a>
                            <h3 class="title"><img src="/static/icon/icon_32.png"/><a href="/dm/index.html">动漫</a></h3>
                            <ul class="nav nav-text pull-right hidden-sm hidden-xs"></ul>
                        </div>
                    </div>
                    <div class="stui-pannel_bd clearfix">
                ...
                <div class="col-lg-4 col-md-3 col-sm-2 col-xs-1 ">
                    <div class="stui-pannel_hd">
                        <div class="stui-pannel__head clearfix"><a class="more text-muted pull-right"
                                                                   href="/dy/index.html">更多 <i
                                class="icon iconfont icon-more"></i></a>
                            <h3 class="title"><img src="/static/icon/icon_12.png"/>电影热播榜</h3></div>
                    </div>
                    <div class="stui-pannel_bd">
                        <ul class="stui-vodlist__rank col-pd clearfix">
                ...
                <div class="col-lg-4 col-md-3 col-sm-2 col-xs-1 ">
                    <div class="stui-pannel_hd">
                        <div class="stui-pannel__head clearfix"><a class="more text-muted pull-right"
                                                                   href="/dsj/index.html">更多 <i
                                class="icon iconfont icon-more"></i></a>
                            <h3 class="title"><img src="/static/icon/icon_12.png"/>电视剧热播榜</h3></div>
                    </div>
                    <div class="stui-pannel_bd">
                        <ul class="stui-vodlist__rank col-pd clearfix">
                ...
                <div class="col-lg-4 col-md-3 col-sm-2 col-xs-1 ">
                    <div class="stui-pannel_hd">
                        <div class="stui-pannel__head clearfix"><a class="more text-muted pull-right"
                                                                   href="/zy/index.html">更多 <i
                                class="icon iconfont icon-more"></i></a>
                            <h3 class="title"><img src="/static/icon/icon_12.png"/>综艺热播榜</h3></div>
                    </div>
                    <div class="stui-pannel_bd">
                        <ul class="stui-vodlist__rank col-pd clearfix">
                ...
                <div class="col-lg-4 col-md-3 col-sm-2 col-xs-1  hidden-md">
                    <div class="stui-pannel_hd">
                        <div class="stui-pannel__head clearfix"><a class="more text-muted pull-right"
                                                                   href="/dm/index.html">更多 <i
                                class="icon iconfont icon-more"></i></a>
                            <h3 class="title"><img src="/static/icon/icon_12.png"/>动漫热播榜</h3></div>
                    </div>
                    <div class="stui-pannel_bd">
                        <ul class="stui-vodlist__rank col-pd clearfix">
        ...
        <div class="stui-pannel stui-pannel-bg hidden-sm hidden-xs clearfix">
            <div class="stui-pannel-box">
                <div class="stui-pannel_hd">
                    <div class="stui-pannel__head clearfix"><h3 class="title"><img src="/static/icon/icon_26.png"/>友情链接
                    </h3></div>
                </div>
                <div class="stui-pannel_bd clearfix">
                    <div class="col-xs-1">
    ...
    <div class="row">
        <div class="stui-foot clearfix">
            ...
            <p class="text-center hidden-xs">Copyright &copy; 2014-2018 <a href="/">特视网</a>联系邮件: teshiw@hotmail.com
                <script type="text/javascript" src="/static/ajs/tj.js"></script>
            </p>
            </a></p></div>
    </div>
</div>
